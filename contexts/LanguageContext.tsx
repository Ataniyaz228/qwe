...
export const translations = {
    ru: {
        ...
        // N8N AI features
        n8n: {
            generateCommit: 'Сгенерировать коммит',
            generating: 'Генерация...',
            generated: 'Сгенерировано!',
            generateError: 'Ошибка генерации',
            codeReview: 'AI Код-ревью',
            codeReviewDesc: 'Получите AI анализ вашего кода',
            startReview: 'Начать ревью',
            reviewing: 'Анализируем...',
            reviewComplete: 'Ревью готово',
            reviewError: 'Ошибка анализа',
            noCode: 'Нет кода для анализа',
            aiPowered: 'AI помощник',
        },
        // Edit post page
        editPost: {
            title: 'Редактирование поста',
            backToPost: 'Назад к посту',
            postNotFound: 'Пост не найден',
            noAccess: 'Нет доступа',
            onlyAuthorCanEdit: 'Вы можете редактировать только свои посты',
            titleLabel: 'Заголовок *',
            ...
            commitMessageLabel: 'Сообщение об изменении',
            commitMessagePlaceholder: 'Что было изменено? (опционально)',
            save: 'Сохранить',
            cancel: 'Отмена',
            saved: 'Пост обновлён!',
            ...
            historyEmpty: 'История изменений пока пуста',
            restore: 'Восстановить',
            restoredFrom: 'Восстановлено из ревизии',
        },
    },
    kk: {
        // Навигация
        ...
        // N8N AI features
        n8n: {
            generateCommit: 'Комитті генерациялау',
            generating: 'Генерация...',
            generated: 'Генерацияланды!',
            generateError: 'Генерация қатесі',
            codeReview: 'AI Код-ревью',
            codeReviewDesc: 'Кодыңызға AI талдауын алыңыз',
            startReview: 'Ревью бастау',
            reviewing: 'Талдауда...',
            reviewComplete: 'Ревью дайын',
            reviewError: 'Талдау қатесі',
            noCode: 'Талдау үшін код жоқ',
            aiPowered: 'AI көмекші',
        },
        // Edit post page
        editPost: {
            title: 'Постты өңдеу',
            backToPost: 'Постқа оралу',
            postNotFound: 'Пост табылмады',
            noAccess: 'Қол жетімсіз',
            onlyAuthorCanEdit: 'Тек өз посттарыңызды өңдей аласыз',
            titleLabel: 'Тақырып *',
            titlePlaceholder: 'Пост атауы',
            descriptionLabel: 'Сипаттама',
            descriptionPlaceholder: 'Қысқаша сипаттама',
            codeLabel: 'Код *',
            codePlaceholder: 'Сіздің кодыңыз...',
            commitMessageLabel: 'Өзгеріс туралы хабарлама',
            commitMessagePlaceholder: 'Не өзгертілді? (міндетті емес)',
            save: 'Сақтау',
            cancel: 'Болдырмау',
            saved: 'Пост жаңартылды!',
            saveError: 'Сақтау қатесі',
            requiredFields: 'Міндетті өрістерді толтырыңыз',
            editing: 'Өңдеу',
            history: 'Тарих',
            historyTitle: 'Өзгерістер тарихы',
            historyEmpty: 'Өзгерістер тарихы бос',
            restore: 'Қалпына келтіру',
            restoredFrom: 'Ревизиядан қалпына келтірілді',
        },
    },
}
